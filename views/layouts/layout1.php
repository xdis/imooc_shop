...
<div class="wrapper">
	...
	echo Nav::widget([
		...
		'items'   => [
			['label' => '首页', 'url' => yii\helpers\Url::to(['index/index'])],
			['label' => '我的购物车', 'url' => yii\helpers\Url::to(['cart/index'])],
			['label' => '我的订单', 'url' => yii\helpers\Url::to(['order/index'])],
		],
	]);
	echo Nav::widget([
		'options' => [
		...
		<div class="container no-padding">
			...
			<div class="col-xs-12 col-sm-12 col-md-3 top-cart-row no-margin">
				<div class="top-cart-row-container">
                    ...
                    <span class="sign">￥</span><span class="value">123</span>
                    </span>
								</div>
							</a>
				...
				<div class="col-xs-12 col-md-8 no-margin">
					...
					<div class="link-widget">
						<div class="widget">
							...
							<ul>
								<?php foreach ($this->params[ 'new' ] as $pro): ?>
									<li><a href="<?php echo yii\helpers\Url::to([
											'product/detail',
											'productid' => $pro->productid,
